...
P(A | B) = P(identical twins | twin bro) = (P(A) * P(B | A)) / P(B)

P(A and B) = P(A)*P(B | A) 
P(A | B) = P(A and B)/ P(B)

P(A) = P(identical twins)
P(B) = P(twin bro)
P(A and B ) = P(identical twins and twin bro)


P(A and B) = 1/2 * 1/300 = 1/600 = 5/3000
P(B) = 1/2 * 1/300 + 1/4 * 1/125 = 1/600 + 1/500 = 11/3000
...
Frequentists dp not assign probabilities to unknown, fixed values, whilst Bayesian stats has no problem doing this (eg. find probability you will get heads?) To answer this Bayesian can get a probability dist over the possible values of a coint, but frequentist stats would give a single answer with no uncertainty measure. One way frequentist stats tries to remedy this is with confidence intervals, but even then all values in the interval are seen as equally likely to occur.
